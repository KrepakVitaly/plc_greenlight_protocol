...
#define MAINTENANCE_PACKET_TOTAL_SIZE    REGULAR_PACKET_TOTAL_SIZE
...
#define MAINTENANCE_PACKET_DATA_SIZE  (MAINTENANCE_PACKET_TOTAL_SIZE - \
...
#if REPEATER_PACKET_TOTAL_SIZE != (REGULAR_PACKET_TOTAL_SIZE+REPEATER_PACKET_ADDRESS_SIZE)
